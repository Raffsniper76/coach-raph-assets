...
(() => {
  ...
  window.__coachRaphHomeV172 = "v49";
...
(() => {
  ...
  window.__coachRaphHomeV361 = "v49";
  ...
  function runCleanPass() {
    // Une seule chaîne de rafraîchissement : le MutationObserver de base marque
    // d'abord la source Notion, puis appelle cette fonction. Cela couvre aussi
    // les remplacements de DOM déclenchés par « Save changes » dans Super.
    window.__coachRaphHomeCoreRefresh?.();
    window.requestAnimationFrame(() => upgradeHome());
  }
