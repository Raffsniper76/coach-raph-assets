...
(() => {
  ...
  /* Super peut laisser une bordure sur le conteneur direct de la zone
     commerciale. On ne marque que ce niveau : marquer tous les ancêtres
     finissait par englober une trop grande partie de la page. */
  function markCommercialWrappers(section, root) {
    root.querySelectorAll(".coach-v31-commercial-wrap, .coach-v32-commercial-wrap")
      .forEach((node) => node.classList.remove("coach-v31-commercial-wrap", "coach-v32-commercial-wrap"));
    if (!section) return;
    section.classList.add("coach-v32-commercial-wrap");
    if (section.parentElement && section.parentElement !== root) {
      section.parentElement.classList.add("coach-v32-commercial-wrap");
    }
  }
