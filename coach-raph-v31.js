...
(() => {
  ...
  /* Les blocs de fin sont parfois enveloppés par plusieurs conteneurs Notion.
     Les marquer permet de neutraliser précisément une éventuelle bordure héritée,
     sans toucher aux vraies cartes qu'ils contiennent. */
  function markCommercialWrappers(section, root) {
    let current = section;
    while (current && current !== root) {
      current.classList.add("coach-v31-commercial-wrap");
