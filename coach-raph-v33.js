...
(() => {
  ...
  function markCommercialWrappers(section, root) {
    root.querySelectorAll(".coach-v31-commercial-wrap, .coach-v32-commercial-wrap, .coach-v33-commercial-wrap")
      .forEach((node) => node.classList.remove("coach-v31-commercial-wrap", "coach-v32-commercial-wrap", "coach-v33-commercial-wrap"));
    if (!section) return;
    ...
    candidates.forEach((node) => {
      ...
      if (node === section || contained >= 3) {
        node.classList.add("coach-v33-commercial-wrap");
