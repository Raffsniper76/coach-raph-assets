...
(() => {
  ...
  function refresh() {
    ...
    refreshTimer = window.setTimeout(() => {
      ...
      /* Pendant nos propres déplacements de blocs, l'observer est coupé. Cela
         évite qu'un changement interne relance immédiatement toute la fin de
         page et perturbe les hover, clics ou sélections de texte. */
      observer?.disconnect();
      try {
        upgradeHome();
      } finally {
