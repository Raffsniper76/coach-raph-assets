/* ============================================================
   Coach Raph — v52 STABLE CONSOLIDATED
...
(() => {
  ...
  function buildPayment(root, source) {
    ...
    payment.innerHTML = `
      <header class="coach-v21-payment-heading">
        ...
        <div><small>Paiement direct</small><h2 id="coach-v21-payment-title">Tu sais quelle formule te convient&nbsp;?</h2><p>Choisis ton programme et accède directement au paiement sécurisé.</p></div>
  ...
  function upgradeAfterSafely(root, section) {
    ...
    [...root.querySelectorAll("details, .notion-toggle")].forEach((toggle) => {
      ...
      if ((/tu sais quelle formule te convient/.test(text) || /deja echange avec coach raph/.test(text)) && /paiement securise/.test(text)) buildPayment(root, toggle);
    });
