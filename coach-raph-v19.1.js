...
(() => {
  ...
  function upgradeMotivationStory(root) {
    if (root.querySelector(".coach-v191-motivation")) return;
    ...
    const story = create("section", "coach-v191-motivation");
    story.dataset.coachGenerated = "motivation-story";
    story.setAttribute("aria-labelledby", "coach-v191-motivation-title");
    story.innerHTML = `
      <header class="coach-v191-motivation-heading">
        <span>Le vrai défi</span>
        <h2 id="coach-v191-motivation-title">L’envie est là.<br>Le plus dur, c’est de durer.</h2>
        <p>Commencer demande une impulsion. Progresser demande surtout un cadre capable de tenir quand le quotidien s’en mêle.</p>
      </header>
      <div class="coach-v191-stat-grid">
        <article class="coach-v191-stat" style="--stat-value:50%;--stat-color:#1764e8;--stat-soft:#eaf2ff">
          <span class="coach-v191-stat-step">01</span>
          <div class="coach-v191-stat-visual coach-v191-stat-ring" aria-hidden="true"><i></i></div>
          <strong>50<small>%</small></strong>
          <h3>L’envie de bouger</h3>
          <p>des Français souhaitent faire davantage d’exercice.</p>
          <em>L’impulsion existe déjà.</em>
        </article>
        <article class="coach-v191-stat" style="--stat-value:33%;--stat-color:#7f5bda;--stat-soft:#f2edff">
          <span class="coach-v191-stat-step">02</span>
          <div class="coach-v191-stat-visual coach-v191-stat-clock" aria-hidden="true"><i></i></div>
          <strong>33<small>%</small></strong>
          <h3>Le rythme se perd</h3>
          <p>disent être moins actifs qu’auparavant.</p>
          <em>Le quotidien reprend le dessus.</em>
        </article>
        <article class="coach-v191-stat" style="--stat-value:50%;--stat-color:#08a775;--stat-soft:#e8fbf4">
          <span class="coach-v191-stat-step">03</span>
          <div class="coach-v191-stat-visual coach-v191-stat-people" aria-hidden="true"><i></i><i></i></div>
          <strong>1<small>sur</small>2</strong>
          <h3>Seul face au programme</h3>
          <p>un sportif sur deux pratique principalement seul.</p>
          <em>Sans repères, durer devient plus difficile.</em>
        </article>
      </div>
      <div class="coach-v191-answer">
        <span class="coach-v191-answer-mark" aria-hidden="true">CR</span>
        <div>
          <small>La réponse Coach Raph</small>
          <h3>La régularité ne devrait pas reposer sur ta volonté seule.</h3>
          <p>Tu avances avec un programme réaliste, un suivi humain et des ajustements adaptés aux imprévus de ton quotidien.</p>
        </div>
        <ul aria-label="Les trois repères de l’accompagnement">
          <li><span>✓</span> Un cadre clair</li>
          <li><span>✓</span> Des points réguliers</li>
          <li><span>✓</span> Un programme qui s’adapte</li>
        </ul>
      </div>
      ${sourceMarkup ? `<details class="coach-v191-sources"><summary>Sources des chiffres</summary><div>${sourceMarkup}</div></details>` : ""}`;

    headingBlock.insertAdjacentElement("beforebegin", story);
    sourceNodes.forEach((node) => hideSource(node, "coach-v191-motivation-source"));
  }
  ...
  function removeRemoteDuplicate(root) {
    ...
    root.querySelectorAll('[data-coach-home-section="remote"], [data-coach-home-heading="remote"]')
      .forEach((node) => {
        if (!node.closest(".coach-v17-manifesto")) hideSource(node, "coach-v191-remote-duplicate");
      });
  }
